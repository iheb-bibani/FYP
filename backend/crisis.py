...
def main():
    store_financial_crisis(
        "European Debt Crisis", "2011-07-01", "2012-06-30", connection
    )

    store_financial_crisis(
        "Chinese Stock Market Crash", "2015-06-12", "2015-08-31", connection
    )

    store_financial_crisis(
        "US-China Trade War Impact", "2018-06-15", "2019-12-13", connection
    )

    store_financial_crisis(
        "2019 Singapore Economic Slowdown", "2019-01-01", "2019-12-31", connection
    )
