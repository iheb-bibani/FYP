...
def main():
    ...
    """
    indicators = ["NGDP_RPCH", "NGDPD", "NGDPDPC", "PPPGDP", "PPPPC", "PPPSH", "PPPEX", "PCPIPCH", "PCPIEPCH", "LP", "BCA", "BCA_NGDPD", "LUR", "GGXCNL_NGDP", "GGXWDG_NGDP",
                  "extensive", "intensive", "total_theil", "SITC1_0", "DirectAbroad", "DirectIn", "PrivInexDI", "PrivInexDIGDP", "ka_new", "ka_in", "ka_out", "FM_ka", "GII_TC",
                  "DEBT1", "PVD_LS", "HH_LS", "NFC_LS", "GGXCNL_G01_GDP_PT", "GGCB_G01_PGDP_PT", "FR_ind"]
